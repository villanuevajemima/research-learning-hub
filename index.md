# Research & Learning Hub — Index

## Core Files

| File | Description |
|------|-------------|
| [project-instructions.md](./project-instructions.md) | Global rules, roles, review process, constraints, workflow |
...
| # | Skill | File |
|---|-------|------|
| 1 | Research Synthesizer | [skill/01-research-synthesizer.md](./skill/01-research-synthesizer.md) |
| 2 | Learning Path Architect | [skill/02-learning-path-architect.md](./skill/02-learning-path-architect.md) |
| 3 | Module Content Builder | [skill/03-module-content-builder.md](./skill/03-module-content-builder.md) |
